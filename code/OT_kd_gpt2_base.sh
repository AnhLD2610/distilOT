...
# model
BASE_PATH="/media/data/thanhnb/Bi/DSKD"
CKPT_TYPE="gpt2"
CKPT_NAME="gpt2-base"
...
TEACHER_MODEL_PATH="/media/data/thanhnb/Bi/DSKD/model_hub/qwen/Qwen1.5-1.8B"
# data
...
CMD="python3 distillation.py ${OPTS}"
echo $CMD
# ${CMD}
${CMD} \
